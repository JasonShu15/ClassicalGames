...
public class ChessBoard extends JPanel implements MouseListener {
    ...
    Point[] chessList=new Point[(ROWS+1)*(COLS+1)];//类后面加中括号也是一种声明数组的方法
    ...
    public ChessBoard(){
        ...
        File boardPic=new File("C:\\Users\\23866\\Desktop\\ClassicalGames\\src\\FiveChess\\board.jpg");
        img=Toolkit.getDefaultToolkit().getImage(boardPic.getPath());//绝对路径
        File shadowPic=new File("C:\\Users\\23866\\Desktop\\ClassicalGames\\src\\FiveChess\\board.jpg");
        shadows=Toolkit.getDefaultToolkit().getImage(shadowPic.getPath());
        addMouseListener(this);
        /*1.MouseListener:鼠标点击事件，相应mouse点击的
          2.MouseMotionListener:鼠标移动事件，移动、拖拽
          */
        addMouseMotionListener(new MouseMotionListener()
        {
            public void mouseDragged(MouseEvent e)//mouseDragged：鼠标拖拽事件,属于MouseMotionListener类的方法，啥事儿都不干
            {

            }
            public void mouseMoved(MouseEvent e)//mouseMoved:鼠标移动事件
            {
